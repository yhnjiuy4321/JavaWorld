...
public class Main {
    public static void main(String[] args) {
        ...
        //Parent child = new Child(); //原本是子類的child，晉升為父類(倒回去看)

        Parent parent = new Parent();
        parent.sayhi(); //父類用父類方法

        Child child1 = new Child();
        Parent parent2 = new Child(); //也等於Parent parent2 = child1(前提要有「Child child1 = new Child()」)
        parent2.sayhi(); //override覆寫:上轉之後，子可以用父之方法且改變使用內容
